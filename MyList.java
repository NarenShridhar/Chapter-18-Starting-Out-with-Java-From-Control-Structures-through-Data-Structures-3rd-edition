...
// Created a generic class MyList with a type parameter T. T is constrained to an upper bound of the Number class.
public class MyList<T extends Number>
{
	...
	*/
	...
	public void add(T numberGiven)
	{
		arrayList.add(numberGiven);
	}
	...
	public T largest()
	{
		...
		*/
		for(int i = 0; i < arrayList.size(); i++)
		{
			...
			if(arrayList.get(i).doubleValue() > largest.doubleValue())
			{
